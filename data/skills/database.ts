...
const database: ISkill[] = [
  {
    ...
    official: "/skills/database/official/mysql-icon.svg",
    description:
  ...
  },
  {
    ...
    official: "/skills/database/official/postgresql-icon.svg",
    description:
  ...
  },
  {
    ...
    official: "/skills/database/official/mongodb-icon.svg",
    description:
  ...
  },
  {
    ...
    official: "/skills/database/official/sqlite-icon.svg",
    description:
  ...
  },
  {
    ...
    official: "/skills/database/official/redis-icon.svg",
    description:
