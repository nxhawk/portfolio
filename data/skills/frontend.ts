...
const frontend: ISkill[] = [
  {
    alt: "html",
    img: "/skills/frontend/html5-original.svg",
    official: "/skills/frontend/official/html5-original-official.svg",
    description:
  ...
  {
    alt: "css",
    img: "/skills/frontend/css3-original.svg",
    official: "/skills/frontend/official/css3-original-official.svg",
    description:
      "Cascading Style Sheets (CSS) is a style sheet language used for specifying the presentation and styling of a document written in a markup language such as HTML or XML (including XML dialects such as SVG, MathML or XHTML).",
  },
  {
    alt: "vite",
    img: "/skills/frontend/vitejsdev-icon.svg",
    official: "/skills/frontend/official/vitejsdev-icon-official.svg",
    description:
      "Vite is a build tool that aims to provide a faster and leaner development experience for modern web projects. It consists of two major parts: A dev server that provides rich feature enhancements over native ES modules, for example extremely fast Hot Module Replacement (HMR). A build command that bundles your code with Rollup, pre-configured to output highly optimized static assets for production.",
  },
  {
    alt: "react",
    img: "/skills/frontend/react.png",
    official: "/skills/frontend/official/reactjs-official.svg",
    description:
  ...
  {
    alt: "vuejs",
    img: "/skills/frontend/vue.svg",
    official: "/skills/frontend/official/vue-official.svg",
    description:
  ...
  {
    alt: "angular",
    img: "/skills/frontend/angular.svg",
    official: "/skills/frontend/official/angular-official.svg",
    description:
  ...
  {
    alt: "next",
    img: "/skills/frontend/nextjs.jpg",
    official: "/skills/frontend/official/nextjs-official.svg",
    description:
  ...
  {
    alt: "nuxt",
    img: "/skills/frontend/nuxtjs.svg",
    official: "/skills/frontend/official/nuxtjs-official.svg",
    description:
  ...
  {
    alt: "flutter",
    img: "/skills/frontend/flutter.svg",
    official: "/skills/frontend/official/flutter-official.svg",
    description:
